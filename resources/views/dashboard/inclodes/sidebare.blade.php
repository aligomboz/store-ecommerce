<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    ...
                    {{--
                    <li><a class="menu-item" href="{{route('sup-categories.create')}}"
        ...
        <li class="nav-item"><a href=""><i class="la la-group"></i>
            ...
            <ul class="menu-content">
                <li class="active"><a class="menu-item" href="{{route('brands.store')}}" data-i18n="nav.dash.ecommerce">
                        عرض الكل </a>
                </li>
                <li><a class="menu-item" href="{{route('brands.create')}}" data-i18n="nav.dash.crypto">أضافة ماركة جديد
                    </a>
                </li>
            </ul>
        </li>
        <li class="nav-item"><a href=""><i class="la la-group"></i>
            ...
            <ul class="menu-content">
                <li class="active"><a class="menu-item" href="{{route('tags.store')}}" data-i18n="nav.dash.ecommerce">
                        عرض الكل </a>
                </li>
                <li><a class="menu-item" href="{{route('tags.create')}}" data-i18n="nav.dash.crypto">أضافة علامة جديد
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="nav-item">
            ...
            <ul class="menu-content">
            <li class="active"><a class="menu-item" href="{{route('products.index')}}" data-i18n="nav.dash.ecommerce">عرض الكل</a>
                </li>
                <li><a class="menu-item" href="{{route('products.create')}}" data-i18n="nav.dash.crypto">أضافة منتج جديد
                </a>
            </li>
            </ul>
        </li>
            ...
            <ul class="menu-content">
                <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">{{__('Means of delivery')}}</a>
                    <ul class="menu-content">
                        ...
                        <li><a class="menu-item" href="{{route('editShippingMethods' , 'inner')}}">{{__('توصيل داخلي')}}
                            </a>
                        </li>
