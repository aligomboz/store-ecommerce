                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{route('updateShippingMethods' , $shipping->id)}}"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{$shipping->value}}" id="name" class="form-control"
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="number" value="{{$shipping->plain_value}}" id="plain_value"
                                                            class="form-control" placeholder="  " name="plain_value">
                                                        @error("plain_value")
                                                        <span class="text-danger">{{$message}}</span>
                                                        @enderror
                                                    </div>
