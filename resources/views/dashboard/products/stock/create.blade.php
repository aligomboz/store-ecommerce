...
<div class="app-content content">
    <div class="content-wrapper">
                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"> ادارة مستودع
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="content-body">manage_stoke
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{route('products.craeteStok')}}" method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="manage_stoke" class="select2 form-control"
                                                            id="manageStock">
