...
@section('content')
@section('title' , 'Index_sup-Category')
            ...
            <div class="content-header-left col-md-6 col-12 mb-2">
                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('sup-categories.index')}}">الرئيسية</a>
                            </li>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group"
                                                            ...
                                                            <a href="{{route('sup-categories.edit',$category ->id)}}"
                                                               class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">تعديل</a>


                                                               <form action="{{route('sup-categories.destroy',$category ->id)}}" method="POST">
                                                                @csrf
                                                                @method('delete')
